...
This repository mirrors the IEEE DataPort dataset record for **ETCS and Railway Network Raw Dataset**:
...
According to the IEEE DataPort record, the dataset:
...
The IEEE DataPort description states that the dataset includes railway and communication-related information such as:
...
Official dataset record on IEEE DataPort:

- **Title:** ETCS and Railway Network Raw Dataset
- **Platform:** IEEE DataPort
- **URL:** <https://ieee-dataport.org/documents/etcs-and-railway-network-raw-dataset>

## Citation

If you use this dataset, please cite the IEEE DataPort record.

```text
KULE MUKUHI, David, Fawzi KHOURI, Rodrigue Fargeon, Leo Mendiboure,
